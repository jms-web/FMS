...
#Region " Variables "
    ...
    ''' </summary>
    Private Shared openForms As New Generic.List(Of ToastForm)
...
#Region " Constructors "
    ...
    ''' </param>
    Public Sub New(lifeTime As Integer,
                   message As String,
                   Optional methodType As FormAnimator.AnimationMethod = FormAnimator.AnimationMethod.Slide,
                   Optional Direction As FormAnimator.AnimationDirection = FormAnimator.AnimationDirection.Down,
...
#Region " Event Handlers "
    ...
    Private Sub messageLabel_MouseEnter(sender As Object, e As EventArgs) Handles messageLabel.MouseEnter
        lifeTimer.Stop()
    End Sub
    ...
    Private Sub messageLabel_MouseLeave(sender As Object, e As EventArgs) Handles messageLabel.MouseLeave
        lifeTimer.Start()
    End Sub
