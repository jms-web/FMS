...
/****** Object:  UserDefinedFunction [dbo].[TV01_HENKO_HIKAKU]    Script Date: 2018/05/11 17:19:48 ******/
SET ANSI_NULLS ON
GO
...
(
	...
	@retTBL TABLE(
	 KOMOKU_NAME	varchar(50)					--項目名
	,MAE_NAIYO		varchar(200)				--変更前内容
	,ATO_NAIYO		varchar(200)				--変更後内容留日数
)
AS
BEGIN
	--V002_NCR_J
	...
	DECLARE @WNJ_TENYO_GOKI					varchar(5);
	...
	DECLARE @WNR_TENYO_GOKI					varchar(5);
	...
	DECLARE @WCJ_KAITO_1				nvarchar(150);
	DECLARE @WCJ_SETUMON_2				nvarchar(100);
	DECLARE @WCJ_KAITO_2				nvarchar(150);
	DECLARE @WCJ_SETUMON_3				nvarchar(100);
	DECLARE @WCJ_KAITO_3				nvarchar(150);	
	DECLARE @WCJ_SETUMON_4				nvarchar(100);
	DECLARE @WCJ_KAITO_4				nvarchar(150);
	DECLARE @WCJ_SETUMON_5				nvarchar(100);
	DECLARE @WCJ_KAITO_5				nvarchar(150);
	DECLARE @WCJ_SETUMON_6				nvarchar(100);
	DECLARE @WCJ_KAITO_6				nvarchar(150);
	DECLARE @WCJ_SETUMON_7				nvarchar(100);	
	DECLARE @WCJ_KAITO_7				nvarchar(150);	
	...
	DECLARE @WCR_KAITO_1				nvarchar(150);
	DECLARE @WCR_SETUMON_2				nvarchar(100);
	DECLARE @WCR_KAITO_2				nvarchar(150);
	DECLARE @WCR_SETUMON_3				nvarchar(100);
	DECLARE @WCR_KAITO_3				nvarchar(150);	
	DECLARE @WCR_SETUMON_4				nvarchar(100);
	DECLARE @WCR_KAITO_4				nvarchar(150);
	DECLARE @WCR_SETUMON_5				nvarchar(100);
	DECLARE @WCR_KAITO_5				nvarchar(150);
	DECLARE @WCR_SETUMON_6				nvarchar(100);
	DECLARE @WCR_KAITO_6				nvarchar(150);
	DECLARE @WCR_SETUMON_7				nvarchar(100);	
	DECLARE @WCR_KAITO_7				nvarchar(150);	
	...
	BEGIN
		...
		--社内コード
		IF @WNJ_SYANAI_CD <> @WNR_SYANAI_CD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--部品番号
		IF @WNJ_BUHIN_BANGO <> @WNR_BUHIN_BANGO
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--部品名称
		IF @WNJ_BUHIN_NAME <> @WNR_BUHIN_NAME
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--不適合状態区分
		IF @WNJ_FUTEKIGO_JYOTAI_KB <> @WNR_FUTEKIGO_JYOTAI_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--不適合状態内容
		IF @WNJ_FUTEKIGO_NAIYO <> @WNR_FUTEKIGO_NAIYO
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--不適合区分
		IF @WNJ_FUTEKIGO_KB <> @WNR_FUTEKIGO_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--不適合詳細区分
		IF @WNJ_FUTEKIGO_S_KB <> @WNR_FUTEKIGO_S_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--図面規格
		IF @WNJ_ZUMEN_KIKAKU <> @WNR_ZUMEN_KIKAKU
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--要求内容
		IF @WNJ_YOKYU_NAIYO <> @WNR_YOKYU_NAIYO
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--観察結果
		IF @WNJ_KANSATU_KEKKA <> @WNR_KANSATU_KEKKA
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--是正処置要否区分
		IF @WNJ_ZESEI_SYOCHI_YOHI_KB <> @WNR_ZESEI_SYOCHI_YOHI_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--是正処置無理由
		IF @WNJ_ZESEI_NASI_RIYU <> @WNR_ZESEI_NASI_RIYU
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--事前審査判定区分
		IF @WNJ_JIZEN_SINSA_HANTEI_KB <> @WNR_JIZEN_SINSA_HANTEI_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--事前審査社員ID
		IF @WNJ_JIZEN_SINSA_SYAIN_NAME <> @WNR_JIZEN_SINSA_SYAIN_NAME
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--事前審査日
		IF @WNJ_JIZEN_SINSA_YMD <> @WNR_JIZEN_SINSA_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再審委員確認社員ID
		IF @WNJ_SAISIN_KAKUNIN_SYAIN_ID <> @WNR_SAISIN_KAKUNIN_SYAIN_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再審委員確認日
		IF @WNJ_SAISIN_KAKUNIN_YMD <> @WNR_SAISIN_KAKUNIN_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再審委員会判定区分
		IF @WNJ_SAISIN_IINKAI_HANTEI_KB <> @WNR_SAISIN_IINKAI_HANTEI_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再審委員技術社員ID
		IF @WNJ_SAISIN_GIJYUTU_SYAIN_ID <> @WNR_SAISIN_GIJYUTU_SYAIN_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再審委員技術確認日
		IF @WNJ_SAISIN_GIJYUTU_YMD <> @WNR_SAISIN_GIJYUTU_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再審委員品証社員ID
		IF @WNJ_SAISIN_HINSYO_SYAIN_ID <> @WNR_SAISIN_HINSYO_SYAIN_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再審委員品証確認日
		IF @WNJ_SAISIN_HINSYO_YMD <> @WNR_SAISIN_HINSYO_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再審委員会資料No
		IF @WNJ_SAISIN_IINKAI_SIRYO_NO <> @WNR_SAISIN_IINKAI_SIRYO_NO
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--顧客再審申請担当ID
		IF @WNJ_KOKYAKU_SAISIN_TANTO_ID <> @WNR_KOKYAKU_SAISIN_TANTO_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--顧客再審申請日
		IF @WNJ_KOKYAKU_SAISIN_YMD <> @WNR_KOKYAKU_SAISIN_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--顧客判定指示区分
		IF @WNJ_KOKYAKU_HANTEI_SIJI_KB <> @WNR_KOKYAKU_HANTEI_SIJI_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--顧客判定指示日
		IF @WNJ_KOKYAKU_HANTEI_SIJI_YMD <> @WNR_KOKYAKU_HANTEI_SIJI_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--顧客最終判定区分
		IF @WNJ_KOKYAKU_SAISYU_HANTEI_KB <> @WNR_KOKYAKU_SAISYU_HANTEI_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--顧客最終判定日
		IF @WNJ_KOKYAKU_SAISYU_HANTEI_YMD <> @WNR_KOKYAKU_SAISYU_HANTEI_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再加工指示フラグ
		IF @WNJ_SAIKAKO_SIJI_FG <> @WNR_SAIKAKO_SIJI_FG
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--廃却年月日
		IF @WNJ_HAIKYAKU_YMD <> @WNR_HAIKYAKU_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--廃却方法区分
		IF @WNJ_HAIKYAKU_KB <> @WNR_HAIKYAKU_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--廃却方法内容
		IF @WNJ_HAIKYAKU_HOUHOU <> @WNR_HAIKYAKU_HOUHOU
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--廃却実施者ID
		IF @WNJ_HAIKYAKU_TANTO_ID <> @WNR_HAIKYAKU_TANTO_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再加工指示文書No
		IF @WNJ_SAIKAKO_SIJI_NO <> @WNR_SAIKAKO_SIJI_NO
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再加工作業完了日
		IF @WNJ_SAIKAKO_SAGYO_KAN_YMD <> @WNR_SAIKAKO_SAGYO_KAN_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--再加工検査年月日
		IF @WNJ_SAIKAKO_KENSA_YMD <> @WNR_SAIKAKO_KENSA_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--検査結果区分
		IF @WNJ_KENSA_KEKKA_KB <> @WNR_KENSA_KEKKA_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--生技社員ID
		IF @WNJ_SEIGI_TANTO_ID <> @WNR_SEIGI_TANTO_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--製造社員ID
		IF @WNJ_SEIZO_TANTO_ID <> @WNR_SEIZO_TANTO_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--検査社員ID
		IF @WNJ_KENSA_TANTO_ID <> @WNR_KENSA_TANTO_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--返却年月日
		IF @WNJ_HENKYAKU_YMD <> @WNR_HENKYAKU_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--返却先
		IF @WNJ_HENKYAKU_SAKI <> @WNR_HENKYAKU_SAKI
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--返却実施者ID
		IF @WNJ_HENKYAKU_TANTO_ID <> @WNR_HENKYAKU_TANTO_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--返却実施備考
		IF @WNJ_HENKYAKU_BIKO <> @WNR_HENKYAKU_BIKO
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--転用先機種ID
		IF @WNJ_TENYO_KISYU_ID <> @WNR_TENYO_KISYU_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--転用先部品番号
		IF @WNJ_TENYO_BUHIN_BANGO <> @WNR_TENYO_BUHIN_BANGO
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--転用先号機
		IF @WNJ_TENYO_GOKI <> @WNR_TENYO_GOKI
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--転用先LOT
		IF @WNJ_TENYO_LOT <> @WNR_TENYO_LOT
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--転用年月日
		IF @WNJ_TENYO_YMD <> @WNR_TENYO_YMD
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置結果a
		IF @WNJ_SYOCHI_KEKKA_A <> @WNR_SYOCHI_KEKKA_A
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置結果b
		IF @WNJ_SYOCHI_KEKKA_B <> @WNR_SYOCHI_KEKKA_B
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置結果C
		IF @WNJ_SYOCHI_KEKKA_C <> @WNR_SYOCHI_KEKKA_C
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置d有無区分
		IF @WNJ_SYOCHI_D_UMU_KB <> @WNR_SYOCHI_D_UMU_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置d要否区分
		IF @WNJ_SYOCHI_D_YOHI_KB <> @WNR_SYOCHI_D_YOHI_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置d処置記録
		IF @WNJ_SYOCHI_D_SYOCHI_KIROKU <> @WNR_SYOCHI_D_SYOCHI_KIROKU
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置e有無区分
		IF @WNJ_SYOCHI_E_UMU_KB <> @WNR_SYOCHI_E_UMU_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置e要否区分
		IF @WNJ_SYOCHI_E_YOHI_KB <> @WNR_SYOCHI_E_YOHI_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置e処置記録
		IF @WNJ_SYOCHI_E_SYOCHI_KIROKU <> @WNR_SYOCHI_E_SYOCHI_KIROKU
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--ファイルパス
		IF @WNJ_FILE_PATH <> @WNR_FILE_PATH
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--画像ファイルパス1
		IF @WNJ_G_FILE_PATH1 <> @WNR_G_FILE_PATH1
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--画像ファイルパス2
		IF @WNJ_G_FILE_PATH2 <> @WNR_G_FILE_PATH2
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
	...
	BEGIN
		...
		--根本要因区分1
		IF @WCJ_KONPON_YOIN_KB1	<>	@WCR_KONPON_YOIN_KB1
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--根本要因区分2
		IF @WCJ_KONPON_YOIN_KB2	<>	@WCR_KONPON_YOIN_KB2
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--根本要因社員ID
		IF @WCJ_KONPON_YOIN_SYAIN_ID	<>	@WCR_KONPON_YOIN_SYAIN_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--帰責工程区分
		IF @WCJ_KISEKI_KOTEI_KB	<>	@WCR_KISEKI_KOTEI_KB
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置実施A社員ID
		IF @WCJ_SYOCHI_A_SYAIN_ID	<>	@WCR_SYOCHI_A_SYAIN_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置実施A日時
		IF @WCJ_SYOCHI_A_YMDHNS	<>	@WCR_SYOCHI_A_YMDHNS
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置実施B社員ID
		IF @WCJ_SYOCHI_B_SYAIN_ID	<>	@WCR_SYOCHI_B_SYAIN_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置実施B日時
		IF @WCJ_SYOCHI_B_YMDHNS	<>	@WCR_SYOCHI_B_YMDHNS
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置実施C社員ID
		IF @WCJ_SYOCHI_C_SYAIN_ID	<>	@WCR_SYOCHI_C_SYAIN_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--処置実施C日時
		IF @WCJ_SYOCHI_C_YMDHNS	<>	@WCR_SYOCHI_C_YMDHNS
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--教育記録ファイルパス
		IF @WCJ_KYOIKU_FILE_PATH <>	@WCR_KYOIKU_FILE_PATH
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--是正処置有効性有無
		IF @WCJ_ZESEI_SYOCHI_YUKO_UMU <>	@WCR_ZESEI_SYOCHI_YUKO_UMU
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--詳細資料Noファイルパス
		IF @WCJ_SYOSAI_FILE_PATH <>	@WCR_SYOSAI_FILE_PATH
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--検査社員ID
		IF @WCJ_KENSA_TANTO_ID	<>	@WCR_KENSA_TANTO_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--検査社員登録日時
		IF @WCJ_KENSA_TOROKU_YMDHNS	<>	@WCR_KENSA_TOROKU_YMDHNS
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--検査GL社員ID
		IF @WCJ_KENSA_GL_SYAIN_ID	<>	@WCR_KENSA_GL_SYAIN_ID
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
		...
		--検査GL社員登録日時
		IF @WCJ_KENSA_GL_YMDHNS	<>	@WCR_KENSA_GL_YMDHNS
			INSERT INTO @retTBL (
			 KOMOKU_NAME	--項目名
			,MAE_NAIYO		--変更前内容
			,ATO_NAIYO		--変更後内容
