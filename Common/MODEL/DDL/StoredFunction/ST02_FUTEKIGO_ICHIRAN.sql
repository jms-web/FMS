USE [FMS]
GO
/****** Object:  StoredProcedure [dbo].[ST02_FUTEKIGO_ICHIRAN]    Script Date: 2023/01/11 11:46:22 ******/
SET ANSI_NULLS ON
GO
...
BEGIN TRY
	...
	DECLARE @W_SURYO						int;
	DECLARE @W_SYOCHI_YOTEI_YMD_A char(8);
	DECLARE @W_SYOCHI_YOTEI_YMD_B char(8);
	DECLARE @W_SYOCHI_YOTEI_YMD_C char(8);
	...
	,SURYO int
	,SYOCHI_YOTEI_YMD_A char(8)
	,SYOCHI_YOTEI_YMD_B char(8)
	,SYOCHI_YOTEI_YMD_C char(8)
	);
	...
	SET @SQL = @SQL + N',SYOCHI_YOTEI_YMD_A';
	SET @SQL = @SQL + N',SYOCHI_YOTEI_YMD_B';
	SET @SQL = @SQL + N',SYOCHI_YOTEI_YMD_C';
	...
	*/
	...
	BEGIN
		...
		,@W_SYOCHI_YOTEI_YMD
		,@W_SURYO
		,@W_SYOCHI_YOTEI_YMD_A
		,@W_SYOCHI_YOTEI_YMD_B
		,@W_SYOCHI_YOTEI_YMD_C
