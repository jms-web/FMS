...
BEGIN TRY
	...
	--集計項目
	SET @SQL += N' SUM(DISTINCT HOKOKU_NO) AS KISO_KENSU';--
	SET @SQL += N',SUM(DISTINCT CASE WHEN CLOSE_FG = ''1'' THEN 1 ELSE 0 END) AS SYOCHI_KENSU';--
	SET @SQL += N',SUM(DISTINCT CASE WHEN CLOSE_FG = ''0'' THEN 1 ELSE 0 END) AS SYOCHI_ZANSU';--
