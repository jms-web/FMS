...
''' </summary>
''' <remarks></remarks>
Public Class RTB_DESADV_Model

#Region "変数・定数"
    Public Const FieldsCount As Integer = 40
    Public Const SourceTableName As String = "RTB_DESADV"
...
#Region "フィールド桁数"
    ...
    Public Const ITEM_023_LEN As Integer = 8
    Public Const ITEM_024_LEN As Integer = 3
    Public Const ITEM_025_LEN As Integer = 30
    Public Const ITEM_026_LEN As Integer = 1
    Public Const ITEM_027_LEN As Integer = 8
    Public Const ITEM_028_LEN As Integer = 2
    Public Const ITEM_029_LEN As Integer = 8
    Public Const ITEM_030_LEN As Integer = 8
    Public Const ITEM_031_LEN As Integer = 4
    Public Const ITEM_032_LEN As Integer = 13
    Public Const ITEM_033_LEN As Integer = 17
    Public Const ITEM_034_LEN As Integer = 8
    Public Const ITEM_035_LEN As Integer = 8
    Public Const ITEM_036_LEN As Integer = 8
    Public Const ITEM_037_LEN As Integer = 8
    Public Const ITEM_038_LEN As Integer = 14
    Public Const ITEM_039_LEN As Integer = 14
    Public Const ITEM_040_LEN As Integer = 119
#End Region
...
#Region "フィールド名"
    ...
    Public Const ITEM_023_NM As String = "SYUYOU_SU"
    Public Const ITEM_024_NM As String = "SU_TANI"
    Public Const ITEM_025_NM As String = "HINMEI"
    Public Const ITEM_026_NM As String = "GYOUMU_KB"
    Public Const ITEM_027_NM As String = "NOU_SIJI_YMD"
    Public Const ITEM_028_NM As String = "BIN_NO"
    Public Const ITEM_029_NM As String = "SYUKKA_YMD"
    Public Const ITEM_030_NM As String = "NOUHIN_NO"
    Public Const ITEM_031_NM As String = "NOUHIN_MEISAI_NO"
    Public Const ITEM_032_NM As String = "NOU_SIJI_NO"
    Public Const ITEM_033_NM As String = "NOU_SIJI_MEISAI_NO"
    Public Const ITEM_034_NM As String = "NOU_SIJI_SU"
    Public Const ITEM_035_NM As String = "SYUKKA_SU"
    Public Const ITEM_036_NM As String = "MINOU_SU"
    Public Const ITEM_037_NM As String = "HAKKOU_YMD"
    Public Const ITEM_038_NM As String = "SYR_YMDHNS"
    Public Const ITEM_039_NM As String = "SYR_NO"
    Public Const ITEM_040_NM As String = "BRANK_SPACE"
#End Region
...
Public Class RTB_DESADV_Entities

#Region "メンバ"
    Private _Entities As Dictionary(Of String, RTB_DESADV_Model)
#End Region

#Region "コンストラクタ"
    Public Sub New()
        _Entities = New Dictionary(Of String, RTB_DESADV_Model)
    End Sub

#End Region

#Region "プロパティ"
    Property prEntities As Dictionary(Of String, RTB_DESADV_Model)
        Get
            Return _Entities
        End Get
        Set(value As Dictionary(Of String, RTB_DESADV_Model))
            _Entities = value
        End Set
    End Property
