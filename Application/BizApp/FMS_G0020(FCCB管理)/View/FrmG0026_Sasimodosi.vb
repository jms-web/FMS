...
''' 差戻し画面
''' </summary>
Public Class FrmG0026_Sasimodosi
...
#Region "更新"
    ...
    Private Function FunSAVE_R003(ByRef DB As ClsDbUtility, ByVal strYMDHNS As String) As Boolean
        ...
        sbSQL.Append(" ,'" & _D009_FCCB_J.HOKOKU_NO & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.BUMON_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._CLOSE_FG & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.KISYU_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SYANAI_CD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.BUHIN_BANGO & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.BUHIN_NAME & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.GOKI & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.SURYO & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J._SAIHATU & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.FUTEKIGO_JYOTAI_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.FUTEKIGO_NAIYO & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.FUTEKIGO_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.FUTEKIGO_S_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.ZUMEN_KIKAKU & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.YOKYU_NAIYO & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.KANSATU_KEKKA & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._ZESEI_SYOCHI_YOHI_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.ZESEI_NASI_RIYU & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.JIZEN_SINSA_HANTEI_KB & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.JIZEN_SINSA_SYAIN_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.JIZEN_SINSA_YMD & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.SAISIN_KAKUNIN_SYAIN_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SAISIN_KAKUNIN_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SAISIN_IINKAI_HANTEI_KB & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.SAISIN_GIJYUTU_SYAIN_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SAISIN_GIJYUTU_YMD & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.SAISIN_HINSYO_SYAIN_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SAISIN_HINSYO_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SAISIN_IINKAI_SIRYO_NO & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.ITAG_NO & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.KOKYAKU_SAISIN_TANTO_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.KOKYAKU_SAISIN_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.KOKYAKU_HANTEI_SIJI_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.KOKYAKU_HANTEI_SIJI_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.KOKYAKU_SAISYU_HANTEI_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.KOKYAKU_SAISYU_HANTEI_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._SAIKAKO_SIJI_FG & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.HAIKYAKU_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.HAIKYAKU_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.HAIKYAKU_HOUHOU & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.HAIKYAKU_TANTO_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SAIKAKO_SIJI_NO & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SAIKAKO_SAGYO_KAN_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SAIKAKO_KENSA_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.KENSA_KEKKA_KB & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.SEIGI_TANTO_ID & "")
        sbSQL.Append(" ," & _D009_FCCB_J.SEIZO_TANTO_ID & "")
        sbSQL.Append(" ," & _D009_FCCB_J.KENSA_TANTO_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.HENKYAKU_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.HENKYAKU_SAKI & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.HENKYAKU_TANTO_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.HENKYAKU_BIKO & "'")
        sbSQL.Append(" ," & _D009_FCCB_J.TENYO_KISYU_ID & "")
        sbSQL.Append(" ,'" & _D009_FCCB_J.TENYO_BUHIN_BANGO & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.TENYO_GOKI & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.TENYO_LOT & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.TENYO_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._SYOCHI_KEKKA_A & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._SYOCHI_KEKKA_B & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._SYOCHI_KEKKA_C & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._SYOCHI_D_UMU_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._SYOCHI_D_YOHI_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SYOCHI_D_SYOCHI_KIROKU & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._SYOCHI_E_UMU_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J._SYOCHI_E_YOHI_KB & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.SYOCHI_E_SYOCHI_KIROKU & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.FILE_PATH & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.HASSEI_YMD & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.G_FILE_PATH1 & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.G_FILE_PATH2 & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.HASSEI_KOTEI_GL_SYAIN_ID & "'")
        sbSQL.Append(" ,'" & _D009_FCCB_J.FCR_KISO_TANTO_ID & "'")
        sbSQL.Append(" );")
        intRET = DB.ExecuteNonQuery(sbSQL.ToString, conblnNonMsg, sqlEx)
        If intRET <> 1 Then
            '-----エラーログ出力
    ...
    Private Function FunGetMODISI_SAKI(ByVal intSYONIN_HOKOKU_ID As Integer, ByVal strHOKOKU_NO As String, ByVal intCurrentStage As Integer) As DataTable
        ...
        With dsList.Tables(0)
            For intCNT = 0 To .Rows.Count - 1
                ...
                If .Rows(intCNT).Item("SYONIN_JUN") = ENM_FCCB_STAGE._10_起草入力 Then
