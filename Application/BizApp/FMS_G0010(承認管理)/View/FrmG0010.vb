    ...
    Private Function FunUpdateEntity(ByVal intMODE As ENM_DATA_OPERATION_MODE) As Boolean
        ...
        Try
            If intMODE = ENM_DATA_OPERATION_MODE._3_UPDATE AndAlso dgvDATA.CurrentRow.Cells(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.SYONIN_HOKOKUSYO_ID)).Value = Context.ENM_SYONIN_HOKOKUSYO_ID._2_CAR Then
                ...
                frmCAR.PrHOKOKU_NO = dgvDATA.GetDataRow().Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.HOKOKU_NO))
                frmCAR.PrCurrentStage = dgvDATA.GetDataRow().Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.SYONIN_JUN))
            ...
            Else
                ...
                Else
                    ...
                    frmNCR.PrHOKOKU_NO = dgvDATA.GetDataRow().Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.HOKOKU_NO))
                    frmNCR.PrCurrentStage = dgvDATA.GetDataRow().Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.SYONIN_JUN))
                End If
                    ...
                    Try
                        ...
                        If MessageBox.Show(strMsg, "処置滞留通知メール送信", MessageBoxButtons.OKCancel, MessageBoxIcon.Information) = DialogResult.OK Then
                            For Each dr As DataRow In dt.CopyToDataTable.Rows
                                ...
                                dr.Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.TAIRYU_NISSU)),
                                dr.Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.HOKOKU_NO)),
                                IIf(dr.Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.KISO_YMD)) <> "", CDate(dr.Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.KISO_YMD))).ToString("yyyy/MM/dd"), ""),
                                dr.Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.KISYU_NAME)),
                                dr.Item(NameOf(MODEL.ST02_FUTEKIGO_ICHIRAN.BUHIN_BANGO)),
