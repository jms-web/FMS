        ...
        Try
            ...
            Using DB As ClsDbUtility = DBOpen()
                ...
                Try '-----トランザクション
                    ...
                    If blnTENSO = False And PrCurrentStage < ENM_NCR_STAGE._999_Closed Then
                ...
                Try
                    ...
                    If Not _D003_NCR_J.FILE_PATH.IsNulOrWS Then
                        If System.IO.File.Exists(lbltmpFile1.Links.Item(0).LinkData) Then
                            If lbltmpFile1.Links.Item(0).LinkData <> strRootDir & _D003_NCR_J.HOKOKU_NO.Trim & "\" & _D003_NCR_J.FILE_PATH Then
                    ...
                    If Not _D003_NCR_J.G_FILE_PATH1.IsNulOrWS Then
                        If System.IO.File.Exists(lblPict1Path.Links.Item(0).LinkData) Then
                            If lblPict1Path.Links.Item(0).LinkData <> strRootDir & _D003_NCR_J.HOKOKU_NO.Trim & "\" & _D003_NCR_J.G_FILE_PATH1 Then
                    ...
                    If Not _D003_NCR_J.G_FILE_PATH2.IsNulOrWS Then
                        If System.IO.File.Exists(lblPict2Path.Links.Item(0).LinkData) Then
                            If lblPict2Path.Links.Item(0).LinkData <> strRootDir & _D003_NCR_J.HOKOKU_NO.Trim & "\" & _D003_NCR_J.G_FILE_PATH2 Then
                    ...
                    If Not _D003_NCR_J.KOKYAKU_SAISIN_FILEPATH1.IsNulOrWS Then
                        If System.IO.File.Exists(lblST08_tmpFile1.Links.Item(0).LinkData) Then
                            If lblST08_tmpFile1.Links.Item(0).LinkData <> strRootDir & _D003_NCR_J.HOKOKU_NO.Trim & "\" & _D003_NCR_J.KOKYAKU_SAISIN_FILEPATH1 Then
                    ...
                    If Not _D003_NCR_J.KOKYAKU_SAISIN_FILEPATH2.IsNulOrWS Then
                        If System.IO.File.Exists(lblST08_tmpFile2.Links.Item(0).LinkData) Then
                            If lblST08_tmpFile2.Links.Item(0).LinkData <> strRootDir & _D003_NCR_J.HOKOKU_NO.Trim & "\" & _D003_NCR_J.KOKYAKU_SAISIN_FILEPATH2 Then
...
#Region "   D003保存"
    ...
    Private Function FunSAVE_D003(ByRef DB As ClsDbUtility, ByVal enmSAVE_MODE As ENM_SAVE_MODE) As Boolean
        ...
        '-----モデル更新
        If (PrCurrentStage = ENM_NCR_STAGE._120_abcde処置確認 And enmSAVE_MODE = ENM_SAVE_MODE._2_承認申請) Then
        ...
        sbSQL.Append($" ,N'{_D003_NCR_J.BUHIN_NAME.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.BUHIN_NAME)}")
        sbSQL.Append($" ,N'{_D003_NCR_J.GOKI.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.GOKI)}")
        ...
        sbSQL.Append($" ,N'{_D003_NCR_J.FUTEKIGO_NAIYO.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.FUTEKIGO_NAIYO)}")
        ...
        sbSQL.Append($" ,N'{_D003_NCR_J.ZUMEN_KIKAKU.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.ZUMEN_KIKAKU)}")
        sbSQL.Append($" ,N'{_D003_NCR_J.YOKYU_NAIYO.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.YOKYU_NAIYO)}")
        sbSQL.Append($" ,N'{_D003_NCR_J.KANSATU_KEKKA.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.KANSATU_KEKKA)}")
        sbSQL.Append($" ,'{_D003_NCR_J._ZESEI_SYOCHI_YOHI_KB}' AS {NameOf(_D003_NCR_J.ZESEI_SYOCHI_YOHI_KB)}")
        sbSQL.Append($" ,N'{_D003_NCR_J.ZESEI_NASI_RIYU.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.ZESEI_NASI_RIYU)}")
        ...
        sbSQL.Append($" ,N'{_D003_NCR_J.SAISIN_IINKAI_SIRYO_NO.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.SAISIN_IINKAI_SIRYO_NO)}")
        sbSQL.Append($" ,N'{_D003_NCR_J.ITAG_NO.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.ITAG_NO)}")
        ...
        sbSQL.Append($" ,N'{_D003_NCR_J.HAIKYAKU_HOUHOU.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.HAIKYAKU_HOUHOU)}")
        ...
        sbSQL.Append($" ,N'{_D003_NCR_J.HENKYAKU_SAKI.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.HENKYAKU_SAKI)}")
        sbSQL.Append($" ,{_D003_NCR_J.HENKYAKU_TANTO_ID} AS {NameOf(_D003_NCR_J.HENKYAKU_TANTO_ID)}")
        sbSQL.Append($" ,N'{_D003_NCR_J.HENKYAKU_BIKO.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.HENKYAKU_BIKO)}")
        sbSQL.Append($" ,{_D003_NCR_J.TENYO_KISYU_ID} AS {NameOf(_D003_NCR_J.TENYO_KISYU_ID)}")
        sbSQL.Append($" ,N'{_D003_NCR_J.TENYO_BUHIN_BANGO.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.TENYO_BUHIN_BANGO)}")
        sbSQL.Append($" ,N'{_D003_NCR_J.TENYO_GOKI.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.TENYO_GOKI)}")
        ...
        sbSQL.Append($" ,N'{_D003_NCR_J.SYOCHI_D_SYOCHI_KIROKU.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.SYOCHI_D_SYOCHI_KIROKU)}")
        ...
        sbSQL.Append($" ,N'{_D003_NCR_J.SYOCHI_E_SYOCHI_KIROKU.ConvertSqlEscape}' AS {NameOf(_D003_NCR_J.SYOCHI_E_SYOCHI_KIROKU)}")
...
#Region "承認"
        ...
        sbSQL.Append($" ,N'{_D004_SYONIN_J_KANRI.RIYU.ConvertSqlEscape}' AS {NameOf(_D004_SYONIN_J_KANRI.RIYU)}")
        sbSQL.Append($" ,N'{_D004_SYONIN_J_KANRI.COMMENT.ConvertSqlEscape}' AS {NameOf(_D004_SYONIN_J_KANRI.COMMENT)}")
...
#Region "   R003保存"
    ...
    Private Function FunSAVE_R003(ByRef DB As ClsDbUtility, ByVal strYMDHNS As String) As Boolean
        ...
        sbSQL.Append(" ,N'" & _D003_NCR_J.BUHIN_NAME & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.GOKI & "'")
        sbSQL.Append(" ," & _D003_NCR_J.SURYO & "")
        sbSQL.Append(" ,'" & _D003_NCR_J._SAIHATU & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J.FUTEKIGO_JYOTAI_KB & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.FUTEKIGO_NAIYO & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J.FUTEKIGO_KB & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J.FUTEKIGO_S_KB & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.ZUMEN_KIKAKU & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.YOKYU_NAIYO & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.KANSATU_KEKKA & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J._ZESEI_SYOCHI_YOHI_KB & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.ZESEI_NASI_RIYU & "'")
        ...
        sbSQL.Append(" ,N'" & _D003_NCR_J.SAISIN_IINKAI_SIRYO_NO & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.ITAG_NO & "'")
        ...
        sbSQL.Append(" ,N'" & _D003_NCR_J.HAIKYAKU_HOUHOU.ConvertSqlEscape & "'")
        ...
        sbSQL.Append(" ,N'" & _D003_NCR_J.HENKYAKU_SAKI.ConvertSqlEscape & "'")
        sbSQL.Append(" ," & _D003_NCR_J.HENKYAKU_TANTO_ID & "")
        sbSQL.Append(" ,N'" & _D003_NCR_J.HENKYAKU_BIKO.ConvertSqlEscape & "'")
        sbSQL.Append(" ," & _D003_NCR_J.TENYO_KISYU_ID & "")
        sbSQL.Append(" ,N'" & _D003_NCR_J.TENYO_BUHIN_BANGO.ConvertSqlEscape & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.TENYO_GOKI.ConvertSqlEscape & "'")
        ...
        sbSQL.Append(" ,N'" & _D003_NCR_J.SYOCHI_D_SYOCHI_KIROKU.ConvertSqlEscape & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J._SYOCHI_E_UMU_KB & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J._SYOCHI_E_YOHI_KB & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.SYOCHI_E_SYOCHI_KIROKU.ConvertSqlEscape & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.FILE_PATH.ConvertSqlEscape & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.G_FILE_PATH1.ConvertSqlEscape & "'")
        sbSQL.Append(" ,N'" & _D003_NCR_J.G_FILE_PATH2.ConvertSqlEscape & "'")
...
#Region "   D003再不適合保存"
    ...
    ''' <param name="DB"></param>
    ''' <returns></returns>
    Private Function FunSAVE_D003_SAI_FUTEKIGO(ByRef DB As ClsDbUtility) As Boolean
        Dim sbSQL As New System.Text.StringBuilder
        Dim strRET As String
        Dim sqlEx As New Exception
        Try
            ...
            sbSQL.Append($" ,'{_D003_NCR_J.SYANAI_CD}' AS {NameOf(_D003_NCR_J.SYANAI_CD)}")
            sbSQL.Append($" ,'{_D003_NCR_J.BUHIN_BANGO}' AS {NameOf(_D003_NCR_J.BUHIN_BANGO)}")
            sbSQL.Append($" ,N'{_D003_NCR_J.BUHIN_NAME}' AS {NameOf(_D003_NCR_J.BUHIN_NAME)}")
            sbSQL.Append($" ,N'{_D003_NCR_J.GOKI}' AS {NameOf(_D003_NCR_J.GOKI)}")
            sbSQL.Append($" ,{_D003_NCR_J.SURYO} AS {NameOf(_D003_NCR_J.SURYO)}")
            sbSQL.Append($" ,'{_D003_NCR_J._SAIHATU}' AS {NameOf(_D003_NCR_J.SAIHATU)}")
            sbSQL.Append($" ,'{_D003_NCR_J.FUTEKIGO_JYOTAI_KB}' AS {NameOf(_D003_NCR_J.FUTEKIGO_JYOTAI_KB)}")
            sbSQL.Append($" ,N'{_D003_NCR_J.FUTEKIGO_NAIYO}' AS {NameOf(_D003_NCR_J.FUTEKIGO_NAIYO)}")
            sbSQL.Append($" ,'{_D003_NCR_J.FUTEKIGO_KB}' AS {NameOf(_D003_NCR_J.FUTEKIGO_KB)}")
            sbSQL.Append($" ,'{_D003_NCR_J.FUTEKIGO_S_KB}' AS {NameOf(_D003_NCR_J.FUTEKIGO_S_KB)}")
            sbSQL.Append($" ,N'{_D003_NCR_J.ZUMEN_KIKAKU}' AS {NameOf(_D003_NCR_J.ZUMEN_KIKAKU)}")
            ...
            sbSQL.Append(" WHEN NOT MATCHED THEN ")
            sbSQL.Append($" INSERT(")
            _D003_NCR_J.Properties.Take(1).ForEach(Sub(p) sbSQL.Append($" {p.Name}"))
            _D003_NCR_J.Properties.Skip(1).ForEach(Sub(p) sbSQL.Append($",{p.Name}"))
            sbSQL.Append($" ) VALUES(")
            _D003_NCR_J.Properties.Take(1).ForEach(Sub(p) sbSQL.Append($" WK.{p.Name}"))
            _D003_NCR_J.Properties.Skip(1).ForEach(Sub(p) sbSQL.Append($",WK.{p.Name}"))
            sbSQL.Append(" )")
            sbSQL.Append("OUTPUT $action AS RESULT;")
...
#Region "               40"
            ...
            If intStageID >= ENM_NCR_STAGE._40_事前審査判定及びCAR要否判定 Then
                dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._40_事前審査判定及びCAR要否判定))
                ...
                If _V003 IsNot Nothing Then
                    ...
                    If intStageID > ENM_NCR_STAGE._40_事前審査判定及びCAR要否判定 Then
                        ...
                        If IsEditingClosed Then
                            cmbST04_JIZENSINSA_HANTEI.ReadOnly = False
                            cmbST04_HASSEI_KOTEI_GL_TANTO.ReadOnly = False
                            pnlST04_ZESEI.Enabled = True
                        Else
...
#Region "               50"
            ...
            If intStageID >= ENM_NCR_STAGE._50_事前審査確認 Then
                dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._50_事前審査確認))
...
#Region "               60"
            ...
            If intStageID >= ENM_NCR_STAGE._60_再審審査判定_技術代表 Then
                dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._60_再審審査判定_技術代表))
...
#Region "               61 7"
            ...
            If intStageID >= ENM_NCR_STAGE._61_再審審査判定_品証代表 Then
                If FunExistAchievement(Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, _D003_NCR_J.HOKOKU_NO, ENM_NCR_STAGE._61_再審審査判定_品証代表) Then
                    dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._61_再審審査判定_品証代表))
...
#Region "               70 8"
            ...
            If intStageID >= ENM_NCR_STAGE._70_顧客再審処置_I_tag Then
                If FunExistAchievement(Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, _D003_NCR_J.HOKOKU_NO, ENM_NCR_STAGE._70_顧客再審処置_I_tag) Then
                    dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._70_顧客再審処置_I_tag))
...
#Region "               80 9"
            ...
            If intStageID >= ENM_NCR_STAGE._80_処置実施 Then
                If FunExistAchievement(Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, _D003_NCR_J.HOKOKU_NO, ENM_NCR_STAGE._80_処置実施) Then
                    dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._80_処置実施))
                    ...
                    Dim dtADD_TANTO As DataTable = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, ENM_NCR_STAGE._10_起草入力)
                    cmbSAI_FUTEKIGO_KISO_TANTO.SetDataSource(dtADD_TANTO, ENM_COMBO_SELECT_VALUE_TYPE._0_Required)
                    If tabST08_SUB.SelectedIndex = ENM_NCR_STAGE80_TABPAGES._2_再加工指示_記録.Value - 1 AndAlso _D003_NCR_J.KENSA_KEKKA_KB.ToVal = ENM_KENSA_KEKKA_KB._1_不合格 Then
                        lblSAI_FUTEKIGO_KISO_TANTO.Visible = True
                        cmbSAI_FUTEKIGO_KISO_TANTO.Visible = True
                        _D003_NCR_J.SAI_FUTEKIGO_KISO_TANTO_ID = _V002_NCR_J.SAI_FUTEKIGO_KISO_TANTO_ID
                    Else
...
#Region "旧 再加工ステージ"
            ...
            '                dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._81_処置実施_生技))
            ...
            '                dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._82_処置実施_製造))
            ...
            '                dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._83_処置実施_検査))
...
#Region "               90 13"
            ...
            If intStageID >= ENM_NCR_STAGE._90_処置実施確認_管理T Then
                dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._90_処置実施確認_管理T))
...
#Region "               100 14"
            ...
            If intStageID >= ENM_NCR_STAGE._100_処置実施決裁_製造課長 Then
                dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._100_処置実施決裁_製造課長))
...
#Region "               110 15"
            ...
            If intStageID >= ENM_NCR_STAGE._110_abcde処置担当 Then
                dt = FunGetSYONIN_SYOZOKU_SYAIN(_D003_NCR_J.BUMON_KB, Context.ENM_SYONIN_HOKOKUSYO_ID._1_NCR, FunGetNextSYONIN_JUN(ENM_NCR_STAGE._110_abcde処置担当))
                ...
                '#90
                Dim blnDISP As Boolean = (_D003_NCR_J.JIZEN_SINSA_HANTEI_KB.ToVal = ENM_JIZEN_SINSA_HANTEI_KB._4_廃却する Or
                    _D003_NCR_J.KOKYAKU_SAISYU_HANTEI_KB.ToVal = ENM_KOKYAKU_SAISYU_HANTEI_KB._3_廃却する.Value)
                ...
                If PrMODE = ENM_DATA_OPERATION_MODE._3_UPDATE Then
                    ...
                    If _V003 IsNot Nothing Then
                        ...
                        If intStageID > ENM_NCR_STAGE._110_abcde処置担当 Then
                            ...
                            If IsEditingClosed Then
                                pnlSYOCHI_A.Enabled = True
                                pnlSYOCHI_B.Enabled = True
                                pnlSYOCHI_C.Enabled = True
                                pnlSYOCHI_D1.Enabled = True
                                pnlSYOCHI_D2.Enabled = True
                                pnlSYOCHI_E1.Enabled = True
                                pnlSYOCHI_E2.Enabled = True
                            Else
                ...
                Sub()
                    Select Case cmb.SelectedValue?.ToString.Trim
                        ...
                        Case Context.ENM_BUMON_KB._2_LP
                            ...
                            cmbHINMEI.ReadOnly = PrCurrentStage > ENM_NCR_STAGE._10_起草入力
                            Me.ActiveControl = cmbSYANAI_CD
                    ...
                    If PrMODE = ENM_DATA_OPERATION_MODE._1_ADD Then
                        ...
                        Else
                            cmbST01_DestTANTO.DataSource = Nothing
                        End If
                    End If
                    ...
                    Else
                        cmbFUTEKIGO_KB.DataSource = Nothing
                    End If
            ...
            Sub()
                ...
                Sub()
                    ...
                    Else
                        ...
                        End If
                    End If
                    If cmbBUHIN_BANGO.SelectedValue Is Nothing OrElse cmbBUHIN_BANGO.SelectedValue.ToString.IsNulOrWS Then
                ...
                Sub()
                    ...
                    If PrCurrentStage = ENM_NCR_STAGE._10_起草入力 Then
                        If cmb.IsSelected AndAlso Not cmb.SelectedValue.ToString.IsNulOrWS() Then
                            ...
                            If dr IsNot Nothing Then
                                If _D003_NCR_J.KISYU_ID = 0 Then
                                    RemoveHandler cmbKISYU.SelectedValueChanged, AddressOf CmbKISYU_SelectedValueChanged
...
#Region "部品名称"
    ...
    Private Sub CmbHINMEI_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles cmbHINMEI.Validating
        Dim cmb As ComboboxEx = DirectCast(sender, ComboboxEx)
        If IsCheckRequired Then
            IsValidated *= ErrorProvider.UpdateErrorInfo(cmb, Not cmb.Text.IsNulOrWS(), String.Format(My.Resources.infoMsgRequireSelectOrInput, "部品名称"))
        End If
    End Sub
...
#Region "不適合区分"
    ...
    Private Async Sub CmbFUTEKIGO_KB_SelectedValueChanged(sender As Object, e As EventArgs) Handles cmbFUTEKIGO_KB.SelectedValueChanged
    ...
    Private Sub CmbST08_2_KENSA_KEKKA_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs)
        ...
        If IsCheckRequired Then
            ...
            If cmb.SelectedValue = 1 Then
                IsValidated *= ErrorProvider.UpdateErrorInfo(numSAI_KAKO_NG_SURYO, numSAI_KAKO_NG_SURYO.Value > 0, String.Format(My.Resources.infoMsgRequireSelectOrInput, "不合格数"))
            End If
        End If
    End Sub
