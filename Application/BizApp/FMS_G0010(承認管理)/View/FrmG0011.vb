...
#Region "   R003保存"
    ...
    Private Function FunSAVE_R003(ByRef DB As ClsDbUtility, ByVal strYMDHNS As String) As Boolean
        ...
        sbSQL.Append(" ,'" & _D003_NCR_J.HAIKYAKU_HOUHOU.ConvertSqlEscape & "'")
        sbSQL.Append(" ," & _D003_NCR_J.HAIKYAKU_TANTO_ID & "")
        sbSQL.Append(" ,'" & _D003_NCR_J.SAIKAKO_SIJI_NO.ConvertSqlEscape & "'")
        ...
        sbSQL.Append(" ,'" & _D003_NCR_J.HENKYAKU_SAKI.ConvertSqlEscape & "'")
        sbSQL.Append(" ," & _D003_NCR_J.HENKYAKU_TANTO_ID & "")
        sbSQL.Append(" ,'" & _D003_NCR_J.HENKYAKU_BIKO.ConvertSqlEscape & "'")
        sbSQL.Append(" ," & _D003_NCR_J.TENYO_KISYU_ID & "")
        sbSQL.Append(" ,'" & _D003_NCR_J.TENYO_BUHIN_BANGO.ConvertSqlEscape & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J.TENYO_GOKI.ConvertSqlEscape & "'")
        ...
        sbSQL.Append(" ,'" & _D003_NCR_J.SYOCHI_D_SYOCHI_KIROKU.ConvertSqlEscape & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J._SYOCHI_E_UMU_KB & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J._SYOCHI_E_YOHI_KB & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J.SYOCHI_E_SYOCHI_KIROKU.ConvertSqlEscape & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J.FILE_PATH.ConvertSqlEscape & "'")
        sbSQL.Append(" ,'" & _D003_NCR_J.G_FILE_PATH1.ConvertSqlEscape & "'")
