            ...
            With dgv
                Select Case dgv.Name
                    Case NameOf(dgvDATA)
                        ...
                        .Columns.Add(NameOf(MODEL.M001_SETTING.ITEM_DISP), "項目名")
...
#Region "検索"
    ...
    Private Function FunGetListData() As DataTable
        Try
            ...
            sbSQL.Append($" WHERE {NameOf(MODEL.M001_SETTING.ITEM_NAME)}='原因分析区分'")
    ...
    Private Function FunGetDgvDetail(ByVal strValue As String) As DataTable
        Try
            ...
            sbSQL.Append($" WHERE {NameOf(MODEL.VWM001_SETTING.ITEM_NAME)}='m-SHELL_{strItemName}区分'")
