    ...
    Public Function FunGetV005Model(ByVal strHOKOKU_NO As String) As V005_CAR_J
        ...
        Else
            ...
            With dsList.Tables(0).Rows(0)
                ...
                _model.GENIN_ETC1 = .Item(NameOf(_model.GENIN_ETC1))
                _model.GENIN_ETC2 = .Item(NameOf(_model.GENIN_ETC2))
...
#Region "レポート出力"
    ...
    Public Function FunMakeReportNCR(ByVal strFilePath As String, ByVal strHOKOKU_NO As String) As Boolean
        ...
        Try
            ...
            Select Case SYOCHI_KB
                ...
                Case ENM_NCR_STAGE80_TABPAGES._2_再加工指示_記録
                    ...
                    If _V002_NCR_J.KENSA_KEKKA_KB.ToVal = ENM_KENSA_KEKKA_KB._1_不合格 Then
                        ...
                        Else
                            ssgSheet1.Range("再加工結果数量").ClearContents()
                        End If
                    Else
            ...
            If _V002_NCR_J.JIZEN_SINSA_HANTEI_KB.ToVal = ENM_JIZEN_SINSA_HANTEI_KB._4_廃却する.Value Or
                _V002_NCR_J.KOKYAKU_SAISYU_HANTEI_KB.ToVal = ENM_KOKYAKU_SAISYU_HANTEI_KB._3_廃却する.Value Then
            ...
            Dim targetDate = _V003_SYONIN_J_KANRI_List.Where(Function(r) r.SYONIN_JUN = ENM_NCR_STAGE._10_起草入力).Select(Function(r) r.ADD_YMDHNS).First
            ...
            Else
                ssgSheet1.Range("A1").Value = "ＦＰ－０９－１２（R）　 別紙－３"
            End If
    ...
    Public Function FunMakeReportCAR(ByVal strFilePath As String, ByVal strHOKOKU_NO As String) As Boolean
        ...
        Try
            ...
            If _V005_CAR_J.SYONIN_YMD10 >= "20220201" Then
                spSheet1.Range("A1").Value = "ＦＰ－０９－１4（H）　別紙－1(a)"
