...
#Region "FORMイベント"
    Private Sub Frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            '-----コントロールデータソース設定
            Me.CmbBUMON_KB.SetDataSource(tblBUMON.ExcludeDeleted, False)
            Me.CmbBUSYO_KB.SetDataSource(tblBUSYO_KB.ExcludeDeleted, True)
            Me.CmbSYOZOKUCYO_NAME.SetDataSource(tblSYAIN, ENM_COMBO_SELECT_VALUE_TYPE._2_Option)
